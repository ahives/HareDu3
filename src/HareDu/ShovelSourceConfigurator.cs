...
/// <summary>
/// Configures the source settings for a RabbitMQ shovel.
/// </summary>
public interface ShovelSourceConfigurator
{
    ...
    void DeleteAfter([NotNull] DeleteShovelMode mode);
    ...
    void Exchange([NotNull] string exchange, [AllowNull] string routingKey = null);
}