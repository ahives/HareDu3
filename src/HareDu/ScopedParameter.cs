namespace HareDu
{
        ...
        BrokerObject
    {
        ...
        /// </summary>
        /// <param name="configuration">Describes how the scoped parameter will be created.</param>
        /// <param name="cancellationToken">Token used cancel the current thread</param>
        /// <returns>Asynchronous task of <see cref="HareDu.Core.Result{TResult}"/></returns>
        Task<Result> Create<T>(Action<NewScopedParameterConfiguration<T>> configuration, CancellationToken cancellationToken = default);
        
        /// <summary>
        /// Delete the specified scoped parameter for a particular component and virtual host on the current RabbitMQ server.
        /// </summary>
        /// <param name="configuration">Describes how the scoped parameter will be delete.</param>
        /// <param name="cancellationToken">Token used cancel the current thread</param>
        /// <returns>Asynchronous task of <see cref="HareDu.Core.Result{TResult}"/></returns>
        Task<Result> Delete(Action<DeleteScopedParameterConfiguration> configuration, CancellationToken cancellationToken = default);
    }
}