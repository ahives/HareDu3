...
public static class TypeExtensions
{
    ...
    /// <returns>
    /// True if the specified type is derived from the given base type; otherwise, false.
    /// </returns>
    ...
    /// <returns>
    /// The first type that matches the predicate if found; otherwise, null.
    /// </returns>
    ...
    /// <returns>
    /// True if the given type implements the specified interface; otherwise, false.
    /// </returns>
    ...
    /// <returns>
    /// A dictionary where the key is the output of the specified function and the value is the corresponding type.
    /// </returns>
    ...
    /// <returns>
    /// True if all keys in the map were successfully registered; otherwise, false.
    /// </returns>
